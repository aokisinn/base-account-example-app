...
import { createBaseAccountSDK, getPaymentStatus, pay } from "@base-org/account";
import {
  BasePayButton,
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.buttonGroup}>
          ...
          {isSignedIn && (
            <div style={styles.signInStatus}>✅ Connected to Base Account</div>
          )}

          <BasePayButton colorScheme={theme} onClick={handlePayment} />
        ...
        {paymentStatus && <div style={styles.status}>{paymentStatus}</div>}
      </div>
    </div>
  );
}
